        ...
        <div className='h-[145vh] max-md:grid relative mt-20   '>
           <div className='h-[100vh] sticky top-0 p-1 max-md:ml-0 max-md:relative ml-[50vw]'>
            ...
            <div className='max-md:w-screen '>
                <div className='flex w-screen md:overflow-x-hidden max-md:ml-0 overflow-x-auto max-md:overflow-auto max-md:overflow-y-hidden   ml-15 gap-5 mt-10 max-md:mt-5'>
...
<div className='max-md:overflow-x-hidden'>
     <div className='flex max-md:mt-5 -ml-100 gap-5 mt-10 max-md:ml-0 md:overflow-hidden '>
                        <div className='flex w-screen md:overflow-x-hidden max-md:ml-0 overflow-x-auto max-md:overflow-y-hidden   ml-15 gap-5 mt-10 max-md:mt-5'>
